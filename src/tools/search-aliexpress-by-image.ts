...
export const searchAliexpressByImageTool: Tool<undefined, typeof parameters> = {
  ...
  description:
    'Retrieve a list of products from AliExpress by product image. This tool returns product details including titles, IDs, URLs, prices, status, review counts, and average ratings. Use this to browse your product catalog or find specific products by image.',
  parameters,
  annotations: {
